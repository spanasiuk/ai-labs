...
public class Lab2Application {
  ...
  public static void main(String[] args) {
    final PersonRiverBeamSearchUtil aStarIntArrayUtil = new PersonRiverBeamSearchUtil(10);
    ...
    final List<Node<Beach[]>> shortestPath = aStarIntArrayUtil.findShortestPath(startNode, null);
